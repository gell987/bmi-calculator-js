...
function BMIFunction(){
    ...
    var inch = document.getElementById("inchInput").value;
    ...
    var meters = document.getElementById('mInput').value;
        ...
        calOut.innerHTML = "Your Minimum Calorie Burn should be " + ((kilograms / (meters * meters)) * (120)).toFixed(2);
        bmi.innerHTML = "Your Body Mass Index is " + bmiValue;
        calIn.innerHTML = "Your Minimum Calorie Intake should be " + ((kilograms / (meters * meters)) * (150)).toFixed(2);
